#!/bin/bash
#SBATCH --job-name=mapdev    # Job name
...
H5AD=/allen/programs/celltypes/workgroups/rnaseqanalysis/EvoGen/Team/Matthew/data/taxtest/extra/KDCbVelocityMouseWbAdultPresupervisionHumanOrthosTFonly.h5ad
REF_PATH=/allen/programs/celltypes/workgroups/rnaseqanalysis/EvoGen/Team/Matthew/data/taxtest/extra/ait_linnarsonjuvenile_tfonly_mapping_reference
...
QUERY_H5AD=/allen/programs/celltypes/workgroups/rnaseqanalysis/EvoGen/Team/Matthew/data/taxtest/HvQvM/HvQvMall_cere_clean_nodoublets.h5ad
OUT_PATH="${QUERY_H5AD%.h5ad}_juvenile-TFonly_MAPPING"
mkdir -p $OUT_PATH
