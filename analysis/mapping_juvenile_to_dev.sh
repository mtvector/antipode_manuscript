...
H5AD=/allen/programs/celltypes/workgroups/rnaseqanalysis/EvoGen/Team/Matthew/data/taxtest/extra/KDCbVelocityMouseWbAdultPresupervisionHumanOrthos.h5ad
REF_PATH=/allen/programs/celltypes/workgroups/rnaseqanalysis/EvoGen/Team/Matthew/data/taxtest/extra/ait_linnarsonjuvenile_mapping_reference
...
OUT_PATH="${QUERY_H5AD%.h5ad}_juvenile_MAPPING"
mkdir -p $OUT_PATH
