...
filepath='/wynton/scratch/mtschmitz/fastqpool/'
...
newfile='/wynton/group/ye/mtschmitz/macaquedevbrain/CAT_chang_h5ad/KDCbVelocityMultiseqkt.h5ad'
min_genes=300
    ...
    for f in fileList:
        ...
        try:
            if os.path.exists(os.path.join(filepath,f,filename,'aem_cellbended_filtered.h5')):
                ...
                sc.pp.filter_cells(sadata,min_genes=min_genes+200)
