...
sc.settings.figdir='/wynton/group/ye/mtschmitz/WBfigures/mouseWbCortexCB202002/'
scv.settings.figdir='/wynton/group/ye/mtschmitz/WBfigures/mouseWbCortexCB202002/'
...
dirs=['GSE123335_cortex','10X_demonstration','PRJNA407881_dropseq_mouse','PRJNA411878_10x_mouse','PRJNA498989_OB_mouse','BICCN_zeng_MOp_v2','BICCN_zeng_MOp_v3','PRJNA637987_lamanno_devmouse','EZE_Kriegstein']

newfile='/wynton/group/ye/mtschmitz/macaquedevbrain/CAT202002_h5ad/KDCbVelocityMouseWbPresupervision.h5ad'

dirs=['GSE123335_cortex','10X_demonstration','PRJNA407881_dropseq_mouse','PRJNA411878_10x_mouse','PRJNA498989_OB_mouse','BICCN_zeng_MOp_v2','BICCN_zeng_MOp_v3','PRJNA637987_lamanno_devmouse','EZE_Kriegstein']

newfile='/wynton/group/ye/mtschmitz/macaquedevbrain/CAT202002_h5ad/KDCbVelocityMouseCortex.h5ad'
...
pth='/wynton/group/ye/mtschmitz/mousefastqpool'
dirs=['GSE123335_cortex','10X_demonstration','PRJNA411878_10x_mouse','BICCN_zeng_MOp_v2','BICCN_zeng_MOp_v3','PRJNA637987_lamanno_devmouse','EZE_Kriegstein']

dirdict={'SRP135960_linnarson_adultmouse':['ob','ctx','ssctx','ca1','dentgyr','cortex','hypothalamus'],
        'PRJNA637987_lamanno_devmouse':['cortex','forebraindorsal']}
...
adata=adata[adata.obs.region.isin(cortex_order),:]

adata.obs['leiden']='nan'
adata.obs['supervised_name']='nan'

cortexregions=['motor','cortex']
#supercell=pd.read_csv('/wynton/group/ye/mtschmitz/macaquedevbrain/MouseSupervisednames.txt')
...
adata.write('/wynton/group/ye/mtschmitz/macaquedevbrain/CAT202002_h5ad/KDCbVelocityMouseWbAdultCortexProcessed.h5ad')
