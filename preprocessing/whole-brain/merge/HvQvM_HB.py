...
sc.settings.figdir='/wynton/group/ye/mtschmitz/WBfigures/HvQvM_HB/'
scv.settings.figdir='/wynton/group/ye/mtschmitz/WBfigures/HvQvM_HB/'
sc.settings.file_format_figs='pdf'
sc.settings.autosave=True
sc.settings.autoshow=False


mdata=sc.read('/wynton/group/ye/mtschmitz/macaquedevbrain/CAT202002_h5ad/KDCbVelocityMouseWbPresupervisionhb_subset.h5ad')
...
qdata=sc.read('/wynton/group/ye/mtschmitz/macaquedevbrain/CAT202002_h5ad/KDCbVelocityMacaqueWbPresupervisehb_subset.h5ad')
...
hdata=sc.read('/wynton/group/ye/mtschmitz/macaquedevbrain/CAT202002_h5ad/KDCbVelocityPanHumanPresupervisehb_subset.h5ad')
...
bbknn.bbknn(adata,batch_key='species',n_pcs=100,neighbors_within_batch=27)
...
adata.write('/wynton/group/ye/mtschmitz/macaquedevbrain/CAT202002_h5ad/HvQvMsmallHB.h5ad')
